...
Feature: Basic tests for groupwise Openbook resource folder files
  ...
  Scenario: Upload two files as lecturer of two groups in a openbook instance and add a openbook block in a quiz
    ...
    And I follow "Edit/upload teacher files"
    And I should see "Teacher files"
    And I upload "blocks/openbook/tests/fixtures/teacher_file_2.pdf" file to "Teacher files" filemanager
    And I press "Save changes"
  ...
  @javascript @_file_upload
  Scenario: Upload two files as student of two groups in a openbook instance and teacher adds a openbook block in a quiz
    When I am on the "Openbook resource folder 1" "openbook activity editing" page logged in as teacher1
    ...
    And I should see "Openbook resource folder files"
    And I should see "Openbook resource folder 1"
    And I am on the "Openbook resource folder 1" "openbook activity" page logged in as student2
    And I should see "Own files"
    And I press "Edit/upload files"
    And I should see "Own files"
    And I upload "blocks/openbook/tests/fixtures/student_file_2_shared.pdf" file to "Own files" filemanager
    And I press "Save changes"
    And I should see "student_file_2_shared.pdf"
    And I log out
    When I am on the "Quiz 1" "quiz activity" page logged in as student1
    And I press "Attempt quiz"
    Then "Openbook resource folder files" "block" should exist
    And I should see "Access is granted to the Openbook resource folder 1 Openbook resource folder containing these files:"
    And I should see "student_file_1_shared.pdf"
    But I should not see "student_file_2_shared.pdf"
    And I am on the "Quiz 1" "quiz activity" page logged in as student2
    And I press "Attempt quiz"
    Then "Openbook resource folder files" "block" should exist
    And I should see "Access is granted to the Openbook resource folder 1 Openbook resource folder containing these files:"
    And I should see "student_file_2_shared.pdf"
    But I should not see "student_file_1_shared.pdf"
