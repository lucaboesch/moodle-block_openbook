...
Feature: Tests for own files in Openbook resource folder
  In order to use Openbook resource folder files in a quiz, uploaded and shared by other users
  As a user
  I need to see the shared files
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | openbook | C1     | Openbook resource folder 2 | 8388608  | 0                | 0                     | 0                     |
  ...
  Scenario: Upload a file as lecturer and an shared file as student in an openbook instance and add a openbook blocks in a quiz
